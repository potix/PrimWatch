...
cp "%{_builddir}/%{package_name}-%{package_version}/src/conf/primwatch.conf" "$RPM_BUILD_ROOT%{install_prefix}/%{package_name}-%{package_version}/conf/"
...
%{install_prefix}/logs
%{install_prefix}/run
%{install_prefix}/%{package_name}-%{package_version}/conf
